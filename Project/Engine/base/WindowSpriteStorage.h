...
private: // 定数
	...
	{
		std::pair{L"Resources/shaders/WindowSprite/WindowSpriteStorage.CS.hlsl", L"mainCopy"}, // レンダーターゲット画像の修正＆コピー
		std::pair{L"Resources/shaders/WindowSprite/WindowSpriteStorage.CS.hlsl", L"mainOverwrite"}, // 上書き
