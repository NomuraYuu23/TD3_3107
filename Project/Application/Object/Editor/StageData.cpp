...
int StageData::LoadNumber = 0;

void StageData::LoadFiles()
{
...
void StageData::LoadFile(const std::string& groupName)
{
...
void StageData::SaveData(const std::string& groupName)
{
	// グループを検索
